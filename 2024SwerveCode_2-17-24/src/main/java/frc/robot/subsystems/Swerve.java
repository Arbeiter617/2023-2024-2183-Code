...
public class Swerve extends SubsystemBase {
    ...
    if(toggleLiemlight.toggleAutoClimb)  {
        //auto climb//
        if(pitch > (0 + posOffset)) {
            //make right side go faster//
            rightALigned = false;
            Constants.climberRight.set(-climber.rightSpeed);
        } else {
            rightALigned = true;
        }
           
           
           if(pitch < (0 - negOffset)) {
            //make left side go faster//
            leftAligned = false;
            Constants.climberLeft.set(-climber.leftSpeed);
           } else {
            leftAligned = true;
           }
           ...
           if(leftAligned && rightALigned) {
            //normally climb -> change color//
            Constants.climberLeft.set(-.15);
            Constants.climberRight.set(-.15);
           }
