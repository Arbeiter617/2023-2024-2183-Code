...
public class Robot extends TimedRobot {
  ...
  //encoders//
   ...
   private static final String kIanDrive = "Ian";
  private static final String kMajorDrive = "Major";
  ...
  public void robotInit() {
    ...
    //set command//
    driverChooser.setDefaultOption("Ian CoPilot", kIanDrive);
    driverChooser.addOption("Major CoPilot", kMajorDrive);
    SmartDashboard.putData("CoPilot Selected", driverChooser);
