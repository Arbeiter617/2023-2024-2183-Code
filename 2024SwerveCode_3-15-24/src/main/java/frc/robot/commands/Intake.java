...
public class Intake extends Command {
     ...
     public void execute() {
        ...
        if(RobotContainer.copilot.getRawButton(3) && !toggleLiemlight.toggleLimelightPos) {
            ...
            } else if(RobotContainer.copilot.getRawButton(1) && colorSensorRun.pieceIsFound && !toggleLiemlight.toggleLimelightPos) {
                //ring in//
    ...
    if(!RobotContainer.pitController.getRawButton(2)) {
        ...
        //System.out.println(Robot.intakeUpEncoder.getPosition());
