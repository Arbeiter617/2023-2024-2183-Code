...
public class RobotContainer {
  ...
  //driver//
  public static frc.robot.autoAlignCommands.humanLoaderIntakeAlign humanLoaderIntakeAlign = new frc.robot.autoAlignCommands.humanLoaderIntakeAlign();
 ...
 String kOnePieceFly = "onePieceFly";
  ...
  public Command getAutonomousCommand() {
    // An ExampleCommand will run in autonomous
      ...
      }else if(Robot.m_autoSelected == kOnePieceFly) {
        return new PathPlannerAuto("onePieceFly");
      }else {
