...
public class Robot extends TimedRobot {
  ...
  //encoders//
   ...
   private static final String kOnePieceFly = "onePieceFly";
   private static final String kTestFivePiece = "Test5Piece";
   private static final String kTwoPieceSide = "twoPieceSide";
  ...
  public void robotInit() {
    ...
    autoChooser.addOption("onePieceFly", kOnePieceFly);
  ...
  public void teleopPeriodic() {
    //hasPiece = colorSensorRun.pieceIsFound;
    //startingConfigLEDs();
    //strobe();
