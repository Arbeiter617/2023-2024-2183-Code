...
public class RobotContainer {
  ...
  public final static Joystick copilot_Joystick = new Joystick(3);
 ...
 String kTwoPieceSide = "twoPieceSide";
  ...
  public Command getAutonomousCommand() {
    // An ExampleCommand will run in autonomous
      ...
      }else if(Robot.m_autoSelected == kTwoPieceSide) {
        return new PathPlannerAuto("twoPieceSide");
      }else {
